...
public final class SignupEmailAuthReactor: Reactor {
    ...
    public func reduce(
        state: SignupEmailAuthReactor.State,
        mutation: SignupEmailAuthReactor.Mutaion
    ) -> SignupEmailAuthReactor.State {
